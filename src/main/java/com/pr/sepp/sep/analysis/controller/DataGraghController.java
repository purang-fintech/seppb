...
public class DataGraghController {
	...
	public List<Map<String, Object>> defectDirection(@RequestParam(value = "relId", required = true) int relId,
	...
	public Map<String, List<Map<String, Object>>> defectDistribution(@RequestParam(value = "relId", required = true) int relId,
			@RequestParam(value = "planType", required = true) int planType) {
