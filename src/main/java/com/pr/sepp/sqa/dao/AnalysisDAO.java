...
public interface AnalysisDAO {
	...
	Map<String, Object> relInfoQuery(int relId);
	...
	Map<String, Object> releaseCmsManpower(int relId);

	Map<String, Object> releaseDefectCount(int relId);
